...
import 'dart:io';
import 'dart:convert';
void main() => runApp(JsonParseObjectSts_SL());
class JsonParseObjectSts_SL extends StatefulWidget {


  JsonParseObjectSts_SL() : super();
...
class _JsonParseObjectsState extends State <StatefulWidget> {
  ...
  final String url = global.urlVar +  '/object_status'   + '?data_area=' + global.dataArea  + '&status=Yes';
//
          ...
          child: ListTile(
              ...
              onTap: () =>
              {
                if ('Yes' == _userDetails[index].sealed) {
                  ...
                  global.userSel = _userDetails[index].userSL,
                  global.dateSel = _userDetails[index].date,
                  global.typesOp = 'Yes',
                  Navigator.push(
                    context,
          ...
          child: ListTile(
              ...
              onTap: () =>
              {
                if ('Так' == _searchResult[i].sealed) {
                  ...
                  global.userSel = _searchResult[i].userSL,
                  global.dateSel = _searchResult[i].date,
                  global.typesOp = 'Так',
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Unseals()),
